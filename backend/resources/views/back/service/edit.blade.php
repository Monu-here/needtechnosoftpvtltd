...
@endsection
@section('linkbar')
    / <a href="{{ route('admin.service.index') }}">Service</a> / Edit
@endsection
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="sub_short_desc" id="sub_short_desc" cols="30" rows="2" class="form-control">{{ $service->sub_short_desc }}</textarea>
                            </div>
                        </div>
                    </div>
