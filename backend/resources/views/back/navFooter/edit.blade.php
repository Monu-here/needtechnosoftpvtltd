...
@endsection
@section('linkbar')
    / <a href="{{ route('admin.navFooter.index') }}">Nav Footer</a> / Edit
@endsection

@section('content')
    <div class="car shadow p-3 mb-3 bg-white">
        <div class="card-body">
            <form action="{{ route('admin.navFooter.edit', ['navFooter' => $navFooter->id]) }}" method="POST">
                @csrf
                <div class="row">
